  ...
  <div class="row">
    <div class="col-md-12">
      <center>@if(session()->has('success'))
        ...
        @endif</center>
      <form action="{{url('emplois/indexSalle')}}" method="post">
        {{csrf_field()}}
         <table class="table">
           <thead>
              <!-- <th>Formateur</th> -->
           ...
           <tbody>
             ...
             <tr><td colspan="2"><center><input value="filter" type="submit" class="form-control btn btn-primary col-md-2"></center></td></tr>
           </tbody>
         </table>
      </form>
    </div>
